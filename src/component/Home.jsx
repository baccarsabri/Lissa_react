...
function Home() {
    ...
    <div className="container">
      <div className="feature_container">
        <div className="box">
          <div className="img-box">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
              x="0px" y="0px" viewBox="0 0 422.518 422.518" 
             >
        ...
        <div className="box">
          <div className="img-box">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
              x="0px" y="0px" viewBox="0 0 315.377 315.377"
             >
              <g>
                <g>
                  <path
  ...
  <section className="health_section layout_padding">
    <div className="health_carousel-container">
      ...
      <img src="images/p-5.jpg"  className="img-fluid" alt=""/>
    </div>
    ...
    <h6 className="mt-3 mb-3">
      ...
      <div className="card " >
      <div className="img-box text-center">
      <img src="images/p-2.jpg"  className="img-fluid" alt=""/>
    </div>
    <div className="text-center">
    <h4 className="fw-bold">
      <strong>Health</strong>
    ...
    <h6 className="mt-3 mb-3">
      ...
      <div className="card " >
      <div className="img-box text-center">
      <img src="images/p-3.jpg"  className="img-fluid" alt=""/>
    </div>
    <div className="text-center">
    <h4 className="fw-bold">
      <strong>Health</strong>
    ...
    <h6 className="mt-3 mb-3">
      ...
      <div className="card " >
      <div className="img-box text-center">
      <img src="images/p-4.jpg"  className="img-fluid" alt=""/>
    </div>
    <div className="text-center">
    <h4 className="fw-bold">
      <strong>Health</strong>
    ...
    <div className="health_carousel-container">
      ...
      <div className="card " >
      <div className="img-box text-center">
      <img src="images/p-6.jpg"  className="img-fluid" alt=""/>
    </div>
    <div className="text-center">
    <h4 className="fw-bold">
      <strong>Medcine</strong>
    </h4>
    <h6 className="mt-3 mb-3">
      <span>
        30
            ...
            <form>
              ...
              <div className="form-group ">
                ...
                <select id="inputState" className="form-control">
                  <option defaultValue>Medicine 1</option>
                  <option defaultValue>Medicine 2</option>
                  <option defaultValue>Medicine 3</option>
                </select>
              </div>
              <div className="form-group">
